    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="padding:40px 50px;">
          <form role="form">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="psw" placeholder="Wachtwoord">
            </div>
            <div class="checkbox">
              <label><input type="checkbox" value="" checked>Onthouden</label>
            </div>
        ...
        <div class="modal-footer">
          ...
          <p>Geen lid? <a href="#">Inschrijven</a></p>
          <p>Vergeet <a href="#">wachtwoord?</a></p>
        </div>
      </div>
